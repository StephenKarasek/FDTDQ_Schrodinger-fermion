function GRAPH_PopulationState(TEXT_, SIM, PULSE, taxis, xaxis)
%% 
close all hidden;
CONSTANTS;
...
saveas(PopStatefig, [TEXT_.saveVisual '\{PopLvl}.' TEXT_.SaveGraphicName]);
